...
public class Bonoloto extends Sorteo{
    private static AtomicInteger atomicInteger = new AtomicInteger(1);
    private int complementario;
    private int reintegro;

    public Bonoloto(String fecha) {
        super(atomicInteger.getAndIncrement(), fecha, NumeroAleatorio.getListaNumerosAleatorios(1,49,6), R.drawable.ic_bonoloto);
    ...
    public boolean equals(@Nullable Object obj) {
        if(obj instanceof Bonoloto && ((Bonoloto)obj).getId() == this.getId())
            return true;
        return false;
    }
}
